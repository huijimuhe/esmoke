...
public class PermUtils {
	...
	private final static int ACCESS_FINE_LOCATION_CODE = 103;
	...
	private PermissionModel[] mPermissionModels = new PermissionModel[] {
			...
			// 定位属于有米可选申请权限
			new PermissionModel("位置信息", Manifest.permission.ACCESS_FINE_LOCATION, "我们需要您允许我们获取的你位置，方便我们为你提供精准的服务",
	...
	public PermUtils(Activity activity) {
		mActivity = activity;
	}
